					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller">
							<ul class="gn-menu">
								...
								<li>
									<a class="gn-icon gn-icon-download" href="registrarAdministrador.jsp?idUser=<%=request.getParameter("idUser")%>&name=<%=request.getParameter("name")%>&empresa=<%=request.getParameter("empresa")%>">Registrar Usuario</a>
								<!--	<ul class="gn-submenu">
