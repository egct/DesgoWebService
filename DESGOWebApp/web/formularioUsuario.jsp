                    ...
                    <nav class="gn-menu-wrapper">
                        <div class="gn-scroller">
                            <ul class="gn-menu">
                                ...
                                <li>
                                    <a class="gn-icon gn-icon-archive" href="formularioUsuario.jsp?idUser=<%=request.getParameter("idUser")%>&name=<%=request.getParameter("name")%>&empresa=<%=request.getParameter("empresa")%>">Formulario</a>
                                </li>
                                <li>
